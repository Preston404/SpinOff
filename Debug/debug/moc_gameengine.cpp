...
QT_MOC_LITERAL(1, 11, 18), // "PlayersListUpdated"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 15) // "SavePlayersFile"

    },
    "GameEngine\0PlayersListUpdated\0\0"
    "SavePlayersFile"
};
...
void GameEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->PlayersListUpdated(); break;
        case 1: _t->SavePlayersFile(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameEngine::PlayersListUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameEngine::PlayersListUpdated()
{
